angular
		...
		.component(
				'wpsExecuteResultDocumentWps2',
				{
					...
					controller : [
							'wpsPropertiesService', 'wpsFormControlService', 'kommonitorMapService', 'wpsGeometricOutputService', '$scope', '$http',
										...
										$http({
											  ...
											  url: url
												...
												if(response.data){
													...
													kommonitorMapService.addComplexOutputToMap(referenceOutput, kommonitorMapService.generateUniqueOutputLayerPropertyName());
												}

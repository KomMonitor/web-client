                    ...
                    "pages": [
                        {
                            ...
                            "pageElements": [
                                ...
                                kommonitorDataExchangeService.getDefaultReportingTemplatePageElement("pageNumber-landscape"),
                                {
                                    ...
                                    "isPlaceholder": true,
                                    "placeholderText": "Übersichtskarte ohne Klassifizierung.\
                        ...
                        },
                        {
                            ...
                            "pageElements": [
                                ...
                                kommonitorDataExchangeService.getDefaultReportingTemplatePageElement("pageNumber-landscape"),
                                {
                                    ...
                                    "isPlaceholder": true,
                                    "placeholderText": "Übersichtskarte klassifiziert.\
									Beschriftung: Quote/Anzahl pro Bereich.\
									Keine Hintergrundkarte.",
                                    "colorScheme": undefined,
                                    "classify": true,
                        ...
                        // datatable might need multiple pages
                        {
                            ...
                            "pageElements": [
                                ...
                                kommonitorDataExchangeService.getDefaultReportingTemplatePageElement("pageNumber-landscape"),
                                {
                                    ...
                                    "isPlaceholder": true,
                                    "placeholderText": "Datentabelle (Spalten: Bereich, Wert).\
                        ...
                        // datatable might need multiple pages
                        {
                            ...
                            "pageElements": [
                                ...
                                kommonitorDataExchangeService.getDefaultReportingTemplatePageElement("pageNumber-landscape"),
                                {
                                    ...
                                    "isPlaceholder": true,
                                    "placeholderText": "Datentabelle (Spalten: Bereich, Zeitpunkt, Wert).\
									Ggf. über mehrere Seiten.",
                                    "columnNames": [],
                                    "tableData": []
                                },
            ...
            $scope.initialize = function () {
                ...
                for (let template of $scope.availableTemplates) {
                    $scope.iteratePageElements(template, function (page, pageElement) {
                        pageElement.isPlaceholder = (pageElement.type === "footerCreationInfo-landscape" ||
                            pageElement.type === "pageNumber-landscape" ||
                            pageElement.type === "textInput") ? false : true;
                    });
                }
                for (let template of $scope.availableTemplates) {
                    for (let page of template.pages) {
                        for (let el of page.pageElements) {
                            el.isPlaceholder = (el.type === "footerCreationInfo-landscape" ||
                                el.type === "pageNumber-landscape" ||
                                el.type === "textInput") ? false : true;
                        }
                    }
                }
            };
...
//# sourceMappingURL=reporting-template-select.component.js.map
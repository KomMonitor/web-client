            ...
            */
            ...
            $scope.initializeLeafletMap = async function (page, pageElement, map, spatialUnit) {
                await $timeout(async function (page, pageElement, echartsMap, spatialUnit) {
                    ...
                    if (prevAttributionDiv)
                        prevAttributionDiv.remove();
                    ...
                    for (let pageElement of page.pageElements) {
                        ...
                        switch (pageElement.type) {
                            ...
                            case "communeLogo-landscape": {
                                ...
                                if (pageElement.src && pageElement.src.length) {
                                    doc.addImage(pageElement.src, "JPEG", pageElementDimensions.left, pageElementDimensions.top, pageElementDimensions.width, pageElementDimensions.height, "", 'MEDIUM');
                                }
                                break;
                            }
                            ...
                            case "barchart": {
                                ...
                                doc.addImage(base64String, "PNG", pageElementDimensions.left, pageElementDimensions.top, pageElementDimensions.width, pageElementDimensions.height, "", 'MEDIUM');
                                break;
                            }
                            case "linechart": {
                                let instance = echarts.getInstanceByDom(pElementDom);
                            ...
                            case "datatable": {
                                ...
                                for (let rowDom of tableRowsDom) { // excluding header
                                    ...
                                    for (let [idx, fieldDom] of fieldsDom.entries()) {
                                        ...
                                        let paragraph = new docx.Paragraph({
                                            text: fieldContent,
                                            alignment: headerFieldNames[idx] === "Wert" ?
...
//# sourceMappingURL=reporting-overview.component.js.map
...
angular.module('indicatorEditMetadataModal').component('indicatorEditMetadataModal', {
    ...
    controller: ['kommonitorDataExchangeService', '$scope', '$rootScope', '$http', '__env', '$timeout', 'kommonitorMultiStepFormHelperService',
        ...
        function IndicatorEditMetadataModalController(kommonitorDataExchangeService, $scope, $rootScope, $http, __env, $timeout, kommonitorMultiStepFormHelperService, kommonitorDataGridHelperService) {
...
//# sourceMappingURL=indicator-edit-metadata-modal.component.js.map
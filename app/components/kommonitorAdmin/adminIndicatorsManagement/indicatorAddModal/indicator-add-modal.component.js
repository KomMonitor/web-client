...
angular.module('indicatorAddModal').component('indicatorAddModal', {
    ...
    controller: ['kommonitorDataExchangeService', 'kommonitorImporterHelperService', '$scope', '$rootScope', '$http', '$timeout',
        ...
        function IndicatorAddModalAddModalController(kommonitorDataExchangeService, kommonitorImporterHelperService, $scope, $rootScope, $http, $timeout, __env, kommonitorMultiStepFormHelperService, kommonitorDataGridHelperService) {
...
//# sourceMappingURL=indicator-add-modal.component.js.map
...
angular.module('georesourceAddModal').component('georesourceAddModal', {
    ...
    controller: ['kommonitorDataExchangeService', 'kommonitorImporterHelperService', '$scope', '$rootScope', '$http', '$timeout',
        ...
        function GeoresourceAddModalAddModalController(kommonitorDataExchangeService, kommonitorImporterHelperService, $scope, $rootScope, $http, $timeout, __env, kommonitorMultiStepFormHelperService, kommonitorDataGridHelperService) {
...
//# sourceMappingURL=georesource-add-modal.component.js.map
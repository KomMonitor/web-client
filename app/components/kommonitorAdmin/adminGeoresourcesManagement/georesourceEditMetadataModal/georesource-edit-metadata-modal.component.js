...
angular.module('georesourceEditMetadataModal').component('georesourceEditMetadataModal', {
    ...
    controller: ['kommonitorDataExchangeService', '$scope', '$rootScope', '$http', '__env', '$timeout', 'kommonitorMultiStepFormHelperService',
        ...
        function GeoresourceEditMetadataModalController(kommonitorDataExchangeService, $scope, $rootScope, $http, __env, $timeout, kommonitorMultiStepFormHelperService, kommonitorDataGridHelperService) {
...
//# sourceMappingURL=georesource-edit-metadata-modal.component.js.map
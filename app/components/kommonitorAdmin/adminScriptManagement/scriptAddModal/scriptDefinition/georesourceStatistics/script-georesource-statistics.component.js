		...
		function ScriptGeoresourceStatisticsController(kommonitorDataExchangeService, kommonitorScriptHelperService, $scope, $rootScope, $http, __env, $timeout, kommonitorCacheHelperService) {
			...
			*/
			...
			$scope.resetComputationFormulaAndLegend = function(){
				...
				var formulaHTML = "<b>Geodatenanalyse: Statistische Berechnung <i>'" + $scope.compMethod.displayName + "' anhand Objekteigenschaft '" + $scope.numericPropertyName + "'</i> f&uuml;r alle Punktobjekte des Datensatzes G<sub>1</sub> innerhalb der jeweiligen Raumeinheit</i>";

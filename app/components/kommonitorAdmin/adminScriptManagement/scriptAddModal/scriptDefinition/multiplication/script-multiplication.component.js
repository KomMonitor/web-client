"use strict";
angular.module('scriptMultiplication').component('scriptMultiplication', {
    templateUrl: "components/kommonitorAdmin/adminScriptManagement/scriptAddModal/scriptDefinition/multiplication/script-multiplication.template.html",
    controller: ['kommonitorDataExchangeService', 'kommonitorScriptHelperService', '$scope', '$rootScope', '$http', '__env', '$timeout',
        function ScriptMultiplicationController(kommonitorDataExchangeService, kommonitorScriptHelperService, $scope, $rootScope, $http, __env, $timeout) {
            this.kommonitorDataExchangeServiceInstance = kommonitorDataExchangeService;
            this.kommonitorScriptHelperServiceInstance = kommonitorScriptHelperService;
            // initialize any adminLTE box widgets
            $('.box').boxWidget();
            $scope.pathToScriptResource = "./kommonitor-script-resources/km_indicator_multiply.js";
            ...
            $scope.parameterDescription = "Komma-separierte Liste aller Indikatoren-IDs zur Multiplikation.";
...
//# sourceMappingURL=script-multiplication.component.js.map
...
angular.module('scriptLineSegmentInPolygon').component('scriptLineSegmentInPolygon', {
    ...
    controller: ['kommonitorDataExchangeService', 'kommonitorScriptHelperService', '$scope', '$rootScope', '$http', '__env', '$timeout',
        ...
        function ScriptLineSegmentInPolygonController(kommonitorDataExchangeService, kommonitorScriptHelperService, $scope, $rootScope, $http, __env, $timeout, kommonitorCacheHelperService) {
...
//# sourceMappingURL=script-line-segment-in-polygon.component.js.map
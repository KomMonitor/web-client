"use strict";
angular.module('scriptPercentage').component('scriptPercentage', {
    templateUrl: "components/kommonitorAdmin/adminScriptManagement/scriptAddModal/scriptDefinition/percentage/script-percentage.template.html",
    controller: ['kommonitorDataExchangeService', 'kommonitorScriptHelperService', '$scope', '$rootScope', '$http', '__env', '$timeout',
        function ScriptPercentagetroller(kommonitorDataExchangeService, kommonitorScriptHelperService, $scope, $rootScope, $http, __env, $timeout) {
            this.kommonitorDataExchangeServiceInstance = kommonitorDataExchangeService;
            this.kommonitorScriptHelperServiceInstance = kommonitorScriptHelperService;
            // initialize any adminLTE box widgets
            $('.box').boxWidget();
            $scope.pathToScriptResource = "./kommonitor-script-resources/km_indicator_percentage.js";
            ...
            $scope.parameterDescription_computationIndicators = "Komma-separierte Liste aller Dividenden Indikatoren-IDs.";
...
//# sourceMappingURL=script-percentage.component.js.map
...
angular.module('scriptAddModal').component('scriptAddModal', {
    ...
    controller: ['kommonitorDataExchangeService', 'kommonitorScriptHelperService', '$scope', '$rootScope', '$http',
        ...
        function ScriptAddModalAddModalController(kommonitorDataExchangeService, kommonitorScriptHelperService, $scope, $rootScope, $http, __env, $timeout, kommonitorMultiStepFormHelperService) {
...
//# sourceMappingURL=script-add-modal.component.js.map
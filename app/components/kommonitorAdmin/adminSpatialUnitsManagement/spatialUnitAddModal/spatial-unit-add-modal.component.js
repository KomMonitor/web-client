...
angular.module('spatialUnitAddModal').component('spatialUnitAddModal', {
    ...
    controller: ['kommonitorDataExchangeService', 'kommonitorImporterHelperService', '$scope', '$rootScope',
        ...
        function SpatialUnitAddModalController(kommonitorDataExchangeService, kommonitorImporterHelperService, $scope, $rootScope, $timeout, $http, __env, kommonitorMultiStepFormHelperService, kommonitorDataGridHelperService) {
...
//# sourceMappingURL=spatial-unit-add-modal.component.js.map
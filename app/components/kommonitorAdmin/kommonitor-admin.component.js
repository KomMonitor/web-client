...
angular
    ...
    .component('kommonitorAdmin', {
    templateUrl: "components/kommonitorAdmin/kommonitor-admin.template.html",
    controller: ['kommonitorDataExchangeService', '$location', "$rootScope", '$scope', function kommonitorAdminController(kommonitorDataExchangeService, $location, $rootScope, $scope) {
...
//# sourceMappingURL=kommonitor-admin.component.js.map
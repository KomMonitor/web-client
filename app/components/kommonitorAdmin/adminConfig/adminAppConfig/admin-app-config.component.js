            ...
            $scope.onChangeAppConfig = function () {
                ...
                $timeout(function () {
                    ...
                    document.getElementById('appConfig_new').innerHTML =
                        PR.prettyPrintOne($scope.appConfigNew, 'javascript', true);
                }, 250);
                $timeout(function () {
                    $scope.$digest();
                });
                ...
                try {
                    ...
                    $timeout(function () {
                        ...
                        document.getElementById('appConfig_current').innerHTML =
                            PR.prettyPrintOne($scope.appConfigCurrent, 'javascript', true);
                    }, 250);
...
//# sourceMappingURL=admin-app-config.component.js.map
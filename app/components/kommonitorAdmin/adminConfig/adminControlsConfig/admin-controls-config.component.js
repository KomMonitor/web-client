            ...
            $scope.onChangeControlsConfig = function () {
                ...
                $timeout(function () {
                    ...
                    document.getElementById('controlsConfig_new').innerHTML =
                        PR.prettyPrintOne($scope.controlsConfigNew, 'javascript', true);
                }, 250);
                $timeout(function () {
                    $scope.$digest();
                });
                ...
                try {
                    ...
                    $timeout(function () {
                        ...
                        document.getElementById('controlsConfig_current').innerHTML =
                            PR.prettyPrintOne($scope.controlsConfigCurrent, 'javascript', true);
                    }, 250);
...
//# sourceMappingURL=admin-controls-config.component.js.map
            ...
            $scope.onChangeKeycloakConfig = function () {
                ...
                $timeout(function () {
                    ...
                    document.getElementById('keycloakConfig_new').innerHTML =
                        PR.prettyPrintOne($scope.keycloakConfigNew, 'javascript', true);
                }, 250);
                $timeout(function () {
                    $scope.$digest();
                });
                ...
                try {
                    ...
                    $timeout(function () {
                        ...
                        document.getElementById('keycloakConfig_current').innerHTML =
                            PR.prettyPrintOne($scope.keycloakConfigCurrent, 'javascript', true);
                    }, 250);
...
//# sourceMappingURL=admin-keycloak-config.component.js.map
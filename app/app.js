...
function ajaxCall_configServerFile() {
  return  $.ajax({
      ...
      success: function(result){
        ...
        return $.when(ajaxCall_keycloakConfig(window.__env.configStorageServerConfig), ajaxCall_controlsConfig(window.__env.configStorageServerConfig), 
        ajaxCall_filterConfig(window.__env.configStorageServerConfig), ajaxCall_appConfig(window.__env.configStorageServerConfig)).then(function(ajax1Results,ajax2Results, ajax3Results){
...
var loadConfigsThenApp = function(){
  ...
  $.when(ajaxCall_keycloakConfig_localBackup(window.__env.configStorageServerConfig), ajaxCall_controlsConfig_localBackup(window.__env.configStorageServerConfig),
    ajaxCall_filterConfig_localBackup(window.__env.configStorageServerConfig)).then(function(ajax1Results,ajax2Results){

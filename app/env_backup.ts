...
export const environment ={
  ...
  */
  ...
  customLogo_onClickURL : "https://www.hochschule-bochum.de/fbg/forschung-und-entwicklung/kommonitor/", // uses <a> tag to insert clickable link on logo
  customLogoWidth : "35px", // height is fixed to 35px, so adjust your custom width to keep aspect ratio
  ...
  customGreetingsTextInfoMessage : "", // as HTML, only set if you want to give users some extra hints, if empty will be ignored
  /*
  ...
  */
  enableSpatialUnitNotificationSelection : false, // controls if a notification should be shown when selecting certain spatial units
  enableSpatialUnitNotificationButton : false, // enables button to manually open spatial unit notification
  spatialUnitNotificationSelection : ["Baublockebene"], // unit(s) for which the notification is shown
  spatialUnitNotificationTitle : "Informationsverlust auf kleinräumigen Ebenen (Bau- und Mittelblock)", // title of the notification window
  ...
  */
  enableExtendedInfoModal : false, // controls if an extra tab should be shown in the info modal. 
  standardInfoModalTabTitle : "Informationen zu KomMonitor", // title of the first tab
  extendedInfoModalTabTitle : "Weitere Informationen", // title of the second tab
  extendedInfoModalHTMLMessage : "", // message in the second tab as HTML
...
baseLayers : [
 ...
 // starting indicator and spatial unit
    ...
    useNoDataToggle : false, // true : hide no data values, false : show no data values

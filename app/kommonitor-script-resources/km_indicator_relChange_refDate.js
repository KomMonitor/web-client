...
async function computeIndicator(targetDate, targetSpatialUnit_geoJSON, baseIndicatorsMap, georesourcesMap, processParameters) {
    ...
    // get reference date
    var referenceDate = KmHelper.getProcessParameterByName_asString(parameterName_referenceDATE, processParameters);
    ...
    var resultMap = KmHelper.changeRelative_referenceDate_percent(computationIndicator, targetDate, referenceDate);
...
//# sourceMappingURL=km_indicator_relChange_refDate.js.map
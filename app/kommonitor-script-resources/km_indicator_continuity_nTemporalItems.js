...
async function computeIndicator(
  ...
  var computationIndicatorId = KmHelper.getProcessParameterByName_asString(
    parameterName_computationIndicatorId,
    processParameters
  );
  var temporalType = KmHelper.getProcessParameterByName_asString(
    parameterName_temporalType,
    processParameters
  );
  var numberOfTemporalItems = KmHelper.getProcessParameterByName_asNumber(
    parameterName_numberOfTemporalItems,
    processParameters
  );

  // get the indicator using the computationIndicatorId
  var computationIndicator = KmHelper.getBaseIndicatorById(

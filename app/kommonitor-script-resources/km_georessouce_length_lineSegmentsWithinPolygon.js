...
async function computeIndicator(
  ...
  var computationGeoresourceId = KmHelper.getProcessParameterByName_asString(
    computationGeoresourceId_name,
    processParameters
  );
  // retrieve required baseIndicator using its meaningful name
  var computationGeoresource = KmHelper.getGeoresourceById(
  ...
  var logProgressIndexSeparator = Math.round(
  ...
  for (
    ...
    var linesWithinFeature = KmHelper.intersectLineFeatureCollectionByPolygonFeature(

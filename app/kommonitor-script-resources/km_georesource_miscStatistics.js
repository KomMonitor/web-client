        ...
        if (pointsWithinFeature && pointsWithinFeature.features && pointsWithinFeature.features.length > 0) {
            ...
            switch (computationMethod) {
                ...
                case ("STANDARD_DEVIATION"):
                    KmHelper.setIndicatorValue(spatialUnitFeat, targetDate, KmHelper.standardDeviation(valueArray));
                    break;
                default:
                    KmHelper.log("Indicator was not computed from computation resources because no valid computation method was chosen. Indicator value is set to null.");
...
//# sourceMappingURL=km_georesource_miscStatistics.js.map
...
async function computeIndicator(
  ...
  var computationIndicatorId_numerator = KmHelper.getProcessParameterByName_asString(
    parameterName_computationIndicatorId_numerator,
    processParameters
  );
  var numeratorGeoJSON = KmHelper.getBaseIndicatorById(
    computationIndicatorId_numerator,
    baseIndicatorsMap
  );

  var computationIndicatorId_denominator = KmHelper.getProcessParameterByName_asString(
    parameterName_computationIndicatorId_denominator,
    processParameters
  );
  var denominatorGeoJSON = KmHelper.getBaseIndicatorById(
  ...
  numeratorGeoJSON.features.forEach(function (feature) {
    ...
    if (numeratorValue === undefined || numeratorValue === null) {
      ...
      KmHelper.log(
        "WARNING: the feature value will thus be set to 'NULL' and computation will abort"
      );
      numeratorValue = null;
    }

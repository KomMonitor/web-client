...
async function computeIndicator(
  ...
  var computationIndicatorIds = KmHelper.getProcessParameterByName_asString(
    parameterName_computationIndicatorIds,
    processParameters
  );
  var computationPolarity = KmHelper.getProcessParameterByName_asString(
    parameterName_computationPolarity,
    processParameters
  );
  var aggregationMethod = KmHelper.getProcessParameterByName_asString(
  ...
  var computationPolarity_array = computationPolarity.split(',');
  ...
  var rankedIndicator_idValueMap_array = [];

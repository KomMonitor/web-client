...
async function computeIndicator(
  ...
  var referenceIndicatorId = KmHelper.getProcessParameterByName_asString(
    parameterName_referenceIndicatorId,
    processParameters
  );
  var referenceGeoJSON = KmHelper.getBaseIndicatorById(referenceIndicatorId, baseIndicatorsMap);

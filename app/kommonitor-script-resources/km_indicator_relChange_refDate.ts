...
const parameterName_referenceDATE = 'REFERENCE_DATE';
...
async function computeIndicator(
  ...
  // get reference date
  const referenceDate = KmHelper.getProcessParameterByName_asString(
    parameterName_referenceDATE,
    processParameters
  );
  ...
  const resultMap = KmHelper.changeRelative_referenceDate_percent(

...
async function computeIndicator(targetDate, targetSpatialUnit_geoJSON, baseIndicatorsMap, georesourcesMap, processParameters){
    ...
    // get reference date
    const referenceDate = KmHelper.getProcessParameterByName_asString(parameterName_referenceDATE, processParameters);
    ...
    const resultMap = KmHelper.changeRelative_referenceDate_percent(computationIndicator, targetDate, referenceDate);

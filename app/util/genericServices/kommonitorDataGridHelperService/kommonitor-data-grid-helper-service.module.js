...
angular
    ...
    .service('kommonitorDataGridHelperService', ['kommonitorDataExchangeService', '$rootScope', '$timeout', '$http', '$httpParamSerializerJQLike', '__env',
    function (kommonitorDataExchangeService, $rootScope, $timeout, $http, $httpParamSerializerJQLike, __env) {
        var self = this;
                    ...
                    onCellValueChanged: function (newValueParams) {
                        ...
                        */
                        ...
                        $http({
                            ...
                            newValueParams.colDef.cellStyle = (p) => p.rowIndex.toString() === newValueParams.node.id ? { 'background-color': '#9DC89F' } : "";
                            ...
                            newValueParams.colDef.cellStyle = (p) => p.rowIndex.toString() === newValueParams.node.id ? { 'background-color': '#E79595' } : "";
                            newValueParams.api.refreshCells({
                                force: true,
                                columns: [newValueParams.column.getId()],
                                rowNodes: [newValueParams.node]
...
//# sourceMappingURL=kommonitor-data-grid-helper-service.module.js.map
 ...
 * marker colors and the LOI dash-pattern SVG lookup. Extracted in the Prio 7
 * god-service split (see documentation/PRIO7_GOD_SERVICE_SPLIT.md); also the
 * home of the POI/LOI constants other consumers import.
 */
@Injectable({
  providedIn: 'root',
})
export class PoiPresentationService {
  selectedPoiSize: PoiSize = DEFAULT_POI_SIZE;

  availablePoiMarkerColors = POI_MARKER_COLORS;

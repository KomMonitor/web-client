...
export class ScriptHelperService {
  ...
  addScriptParameter(parameterName, parameterDescription, parameterDataType, parameterDefaultValue, parameterNumericMinValue, parameterNumericMaxValue){
  ...
  */
    ...
    return await this.httpClient.post(this.targetUrlToManagementService + "process-scripts", postBody,{headers: header}).subscribe({
      next: response => {
        return response;
      },
      error: error => {
  ...
  async updateScript(scriptName, description, scriptId){
    ...
    return await this.httpClient.post(this.targetUrlToManagementService + "process-scripts/" + scriptId, putBody, {headers: header}).subscribe({
      next: response => {
        return response;
      },
      error: error => {
  ...
  styleMathFormula(domOutputElementId){
    var output:any = document.getElementById(domOutputElementId);
  ...
  typesetContainerByClass(className){
    var domElements:any = document.getElementsByClassName(className);

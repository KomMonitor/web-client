// (function (window) {
  ...
  window.__env.apiUrl = 'http://kommonitor.muelheim-ruhr.de/';
  ...
  window.__env.targetUrlToProcessingEngine = 'http://kommonitor.muelheim-ruhr.de/processing/';
  ...
  window.__env.targetUrlToReachabilityService_OTP = 'http://kommonitor.muelheim-ruhr.de/opentripplanner';
  // window.__env.targetUrlToReachabilityService_OTP = 'http://localhost:8090/opentripplanner';

  // Data Imporert URL
  window.__env.targetUrlToImporterService = 'http://kommonitor.muelheim-ruhr.de/importer';

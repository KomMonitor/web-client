// (function (window) {
  ...
  window.__env.apiUrl = 'https://kommonitor-mh.fbg-hsbo.de/';
  ...
  window.__env.targetUrlToProcessingEngine = 'https://kommonitor-mh.fbg-hsbo.de/processing/';
  ...
  window.__env.targetUrlToReachabilityService_OTP = 'https://kommonitor-mh.fbg-hsbo.de/opentripplanner';
  // window.__env.targetUrlToReachabilityService_OTP = 'http://localhost:8090/opentripplanner';

  // Data Imporert URL
  window.__env.targetUrlToImporterService = 'https://kommonitor-mh.fbg-hsbo.de/importer';

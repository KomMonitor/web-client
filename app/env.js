// (function (window) {
  ...
  window.__env.apiUrl = 'https://kommonitor-gib.fbg-hsbo.de/';
  ...
  window.__env.targetUrlToProcessingEngine = 'https://kommonitor-gib.fbg-hsbo.de/processing';
  ...
  // Data Imporert URL
  window.__env.targetUrlToImporterService = 'https://kommonitor-gib.fbg-hsbo.de/importer/';

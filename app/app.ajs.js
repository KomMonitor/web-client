...
var decryptAesCBC = function (encryptedString) {
    ...
    var iv = CryptoJS.lib.WordArray.create(encryptedWordArray.words.slice(0, (env.encryption.ivLength_byte) / 4));
    var decrypted = CryptoJS.AES.decrypt({
        ciphertext: CryptoJS.lib.WordArray.create(encryptedWordArray.words.slice(env.encryption.ivLength_byte / 4))
    }, hashedKey, { iv: iv });
...
//# sourceMappingURL=app.ajs.js.map